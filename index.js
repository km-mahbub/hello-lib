...
switch (platform) {
  case 'android':
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'hello-lib.android-arm64.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'hello-lib.android-arm-eabi.node'))
        try {
          if (localFileExisted) {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'hello-lib.win32-x64-msvc.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'ia32':
        localFileExisted = existsSync(join(__dirname, 'hello-lib.win32-ia32-msvc.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'hello-lib.win32-arm64-msvc.node'))
        try {
          if (localFileExisted) {
    ...
    break
  case 'darwin':
    localFileExisted = existsSync(join(__dirname, 'hello-lib.darwin-universal.node'))
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'hello-lib.darwin-x64.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'hello-lib.darwin-arm64.node'))
        try {
          if (localFileExisted) {
  ...
  case 'freebsd':
    ...
    localFileExisted = existsSync(join(__dirname, 'hello-lib.freebsd-x64.node'))
    try {
      if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'hello-lib.linux-x64-musl.node'))
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'hello-lib.linux-x64-gnu.node'))
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'hello-lib.linux-arm64-musl.node'))
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'hello-lib.linux-arm64-gnu.node'))
          try {
            if (localFileExisted) {
        ...
        break
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'hello-lib.linux-arm-gnueabihf.node'))
        try {
          if (localFileExisted) {
...
const { plus100, add, getData } = nativeBinding
